...
Tee funktio, joka laskee tuotteen kokonaishinnan, kun sen parametrit ovat hinta ja 
LV-prosentti (desimaalilukuna). Ennen ALV:in lisäämistä hinnasta vähennetään alennus 
...
function finalPrice(/*lisää itse parametrit tähän*/){
    // lisää koodia tähän
}
